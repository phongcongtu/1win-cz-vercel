        ...
        <div class="container-wrap">
          <div class="top-menu">
            <div class="row">
              <div class="col-xs-2">
                <div id="fh5co-logo">
                  <a href="index.php" style="font-size: 10px">Promotion</a>
                </div>
              </div>
              <div class="col-xs-10 text-right menu-1">
                <ul>
                  ...
                  <li class="active"><a href="terms.php">Terms and conditions</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <section class="text-center">
            <div>
              ...
              <p>
                ...
                <span class="server-name"></span>'s Website, located at
              ...
              <p>
                We employ the use of cookies. By accessing <span class="server-name"></span>, you
                agreed to use cookies in agreement with the <span class="server-name"></span>'s
                Privacy Policy.
              </p>

              <p>
                Most interactive websites use cookies to let us retrieve the userвЂ™s details for
              ...
              <p>
                Unless otherwise stated, <span class="server-name"></span> and/or its licensors own
                the intellectual property rights for all material on
                <span class="server-name"></span>. All intellectual property rights are reserved.
              ...
              <ul>
                ...
                <li>
                  Reproduce, duplicate or copy material from <span class="server-name"></span>
                </li>
              ...
              <p>
                ...
                and information in certain areas of the website.
                <span class="server-name"></span> does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect the views and
                opinions of <span class="server-name"></span>,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, <span class="server-name"></span> shall not
                be liable for the Comments or for any liability, damages or expenses caused and/or
                suffered as a result of any use of and/or posting of and/or appearance of the
                Comments on this website.
              </p>

              <p>
                <span class="server-name"></span> reserves the right to monitor all Comments and to
              ...
              <p>
                ...
                <span class="server-name"></span>; and (d) the link is in the context of general
              ...
              <p>
                No use of <span class="server-name"></span>'s logo or other artwork will be allowed
